...
# Source Info
  ...
  s.source_files =  'PIXNET-iOS-SDK/Classes/*.{h,m}', 'PIXNET-iOS-SDK/Classes/LROAuth2Client/*.{h,m}, 'PIXNET-iOS-SDK/PIXNET-iOS-SDK/en.lproj/', 'PIXNET-iOS-SDK/PIXNET-iOS-SDK/zh-Hant.lproj/'
